...
function WorkoutDetails() {
  ...
  return (
    <div>
      <h1 className="topic">
        Your Workout Status<span className="topicsub"> Details..!</span>
      </h1>
      <div className="table_main">
        <button type="button" className="nav_btn_add" onClick={()=>(window.location.href='/addworkout')}>Add New</button>
